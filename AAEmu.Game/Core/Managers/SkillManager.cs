                ...
                using (var reader = new SQLiteWrapperReader(command.ExecuteReader()))
                {
                    while (reader.Read())
                    {
                        var template = new OpenPortalEffect {
                            ...
                            portalEnterId = !reader.IsDBNull("enter_portal_npc_id") ? reader.GetUInt32("enter_portal_npc_id") : 3891u,
                            portalExitId = !reader.IsDBNull("exit_portal_npc_id") ? reader.GetUInt32("exit_portal_npc_id") : 6949u
                        };
